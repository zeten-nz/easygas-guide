...
const CODE_TO_KEY: Record<string, MessageKey> = {
  ...
  CONFLICT_RETRY: 'error.CONFLICT_RETRY',
  STEP_STATE_CHANGED: 'error.STEP_STATE_CHANGED',
  JOB_STATE_CHANGED: 'error.JOB_STATE_CHANGED',
  STORAGE_UNAVAILABLE: 'error.STORAGE_UNAVAILABLE',
  CRITICAL_RISK_UNRESOLVED: 'error.CRITICAL_RISK_UNRESOLVED',
  REQUIRED_PHOTOS_MISSING: 'error.REQUIRED_PHOTOS_MISSING',
  CUSTOMER_SIGNATURE_REQUIRED: 'error.CUSTOMER_SIGNATURE_REQUIRED',
  CHECKLIST_INCOMPLETE: 'error.CHECKLIST_INCOMPLETE',
  STOP_APPROVAL_PENDING: 'error.STOP_APPROVAL_PENDING',
  STOP_REJECTED: 'error.STOP_REJECTED',
  RISK_POLICY_NOT_APPROVED: 'error.RISK_POLICY_NOT_APPROVED',
  TEMPLATE_HAS_HISTORY: 'error.TEMPLATE_HAS_HISTORY',
};
